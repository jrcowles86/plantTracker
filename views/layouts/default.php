...
<body>
    ...
    <div class="nav-container">
        <div class="nav-cntnr-left">
            <a class="nav-logo-link" href="/home/index">plant<b class="logo-accent">Tracker</b></a>
        </div>
        <div class="nav-cntnr-right">
            <ul class="nav-list">
                ...
                <li class="nav-list-item">
                    <a class="login-link" href="/register/login">
                        <i class="far fa-user-circle"></i>
                    </a>
                </li>
                <li class="nav-list-item">
                    <a class="login-link" href="/register/logout">
